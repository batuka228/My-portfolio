export const WorkCardImg = () => {
  return (
    <div className="flex py-[48px] px-[48px] justify-center dark:bg-gray-600 items-center self-stretch white:bg-gradient-to-t from-gray-100 ">
      <img
        className=" bg-gray-50 bg-no-repeat"
